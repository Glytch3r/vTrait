...
-----------------------            ---------------------------
--[[ 
function vTrait.disableEatDrink(player, context, items)
    local pl = getSpecificPlayer(player)
    if not pl:HasTrait("V") then return end

    local isDrinkDisabled = SandboxVars.vTrait.DisableDrink or true
    local isEatDisabled = SandboxVars.vTrait.DisableEat or true
...
Events.OnFillInventoryObjectContextMenu.Add(vTrait.disableEatDrink)
 ]]
